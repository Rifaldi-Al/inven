...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Create Kode Surat</div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('kode_surat.store') }}">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="kode_surat" name="kode_surat" value="{{ old('kode_surat') }}" readonly required>
                        </div>
                        {{-- <div class="form-group">
