...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Create Laporan Aset Pegawai</div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('laporan.store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="pegawai" name="pegawai" value="{{ old('pegawai') }}">
                        </div>

                        <div class="form-group">
                            <label for="masuk">Tanggal Aset Masuk:</label>
                            <input type="date" class="form-control" id="masuk" name="masuk" value="{{ old('masuk') }}">
                        </div>
